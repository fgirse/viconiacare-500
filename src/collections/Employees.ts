          ...
          fields: [
            {
              ...
              options: [
                { label: { de: 'Geschäftsführender Gesellschafter', en: 'Managing Partner' }, value: 'Managing Partner' },
                { label: { de: 'Strategie und Qualitätsmanagement', en: 'Strategy and Quality Management' }, value: 'Strategy and Quality Management' },
                { label: { de: 'IT/Webmaster', en: 'IT Management/Webmaster' }, value: 'IT Management/Webmaster' },
                { label: { de: 'Geschäftsführung', en: 'Management' }, value: 'Management' },
                { label: { de: 'Pflegedienstleitung', en: 'Nursing Management' }, value: 'Nursing Management' },
                { label: { de: 'Verwaltung', en: 'Administration' }, value: 'Administration' },
                { label: { de: 'Alltagsbegleiter', en: 'Everyday Companion' }, value: 'Everyday Companion' },
                { label: { de: 'Pflegeassistent', en: 'Care Assistant' }, value: 'Care Assistant' },
                { label: { de: 'Pflegehilfskraft', en: 'Auxiliary Nurse' }, value: 'Auxiliary Nurse' },
                { label: { de: 'Altenpflegeauszubildende/r', en: 'Geriatric Nursing Trainee' }, value: 'Geriatric Nursing Trainee' },
                { label: { de: 'Altenpflegehelfer/in', en: 'Geriatric Nursing Assistant' }, value: 'Geriatric Nursing Assistant' },
                { label: { de: 'Altenpfleger/in', en: 'Geriatric Nurse' }, value: 'Geriatric Nurse' },
                { label: { de: 'Examinierte Pflegefachkraft', en: 'Registered Nurse (RN)' }, value: 'Registered Nurse (RN)' },
                { label: { de: 'Hauswirtschaftskraft', en: 'Domestic Helper' }, value: 'Domestic Helper' },
                { label: { de: 'Wundmanager', en: 'Wound Manager' }, value: 'Wound Manager' },
              ],
            },
            {
            ...
            },
            {
              ...
              options: [
                { label: { de: 'Vollzeit', en: 'Full-time' }, value: 'Full-time' },
                { label: { de: 'Teilzeit', en: 'Part-time' }, value: 'Part-time' },
